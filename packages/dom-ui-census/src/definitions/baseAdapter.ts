...
const queryElementAdapter = createDOMAdapter(
  ...
  {
    getElement: (element) => <ElementType extends Element>() =>
      element as ElementType,
  }
);

const queryHTMLElementAdapter = chainAdapter(
  queryElementAdapter,
    ...
    query(queryStr).contains({ isHTMLElement: true }).all(),
  {
     ...
     */
    accessKey: (element) => element.getElement<HTMLElement>().accessKey,
    /**
    ...
    autoCapitalize: (element) =>
      element.getElement<HTMLElement>().autocapitalize as any,
    /** List of the classes of the element */
    classNames: (element) =>
      Array.from(element.getElement<HTMLElement>().classList),
    /**
    ...
    contentEditable: (element) => {
      if (element.getElement<HTMLElement>().contentEditable === "false") {
        return false;
      } else {
        return true;
      }
    ...
    dataAttributes: (element) =>
      Object(element.getElement<HTMLElement>().dataset),
    /**
     ...
     */
    dir: (element) => element.getElement<HTMLElement>().dir as any,
    /**
     * An enumerated attribute indicating whether the element can be dragged, using the Drag and Drop API.
     */
    draggable: (element) => element.getElement<HTMLElement>().draggable,
    /**
     ...
     */
    hidden: (element) => element.getElement<HTMLElement>().hidden,
    /**
     * Defines a unique identifier (ID) which must be unique in the whole document.
     * Its purpose is to identify the element when linking (using a fragment identifier), scripting, or styling (with CSS).
     */
     ...
     */
    inputMode: (element) => element.getElement<HTMLElement>().inputMode,
    /**
     ...
     */
    lang: (element) => element.getElement<HTMLElement>().lang,
    /**
     * An enumerated attribute defines whether the element may be checked for spelling errors. It may have the following values:
     * **true**, which indicates that the element should be, if possible, checked for spelling errors;
     * **false**, which indicates that the element should not be checked for spelling errors.
     */
    spellcheck: (element) => element.getElement<HTMLElement>().spellcheck,
    /**
     * Contains inline CSS styling declarations to be applied to the element.
     */
    style: (element) => Object(element.getElement<HTMLElement>().style),
    /**
     ...
     */
    tabIndex: (element) => element.getElement<HTMLElement>().tabIndex,
    /**
     ...
     */
    title: (element) => element.getElement<HTMLElement>().title,
  },
  {}
);
